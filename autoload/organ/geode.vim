...
if ! exists('s:plugs_normal')
	let s:plugs_normal = [
		...
		\ [ 'organ-shift-meta-left'               , 'organ#nest#shift_meta_left()'             ] ,
		\ [ 'organ-shift-meta-right'              , 'organ#nest#shift_meta_right()'            ] ,
		\ [ 'organ-shift-meta-up'                 , 'organ#nest#shift_meta_up()'               ] ,
		\ [ 'organ-shift-meta-down'               , 'organ#nest#shift_meta_down()'             ] ,
