...
if ! exists('s:speedkeys')
	let s:speedkeys = [
		...
		\ [ '<',        "organ#eagle#oper('promote')"               ] ,
		\ [ '>',        "organ#eagle#oper('demote')"                ] ,
		\ [ 'H',        "organ#eagle#oper('promote_subtree')"       ] ,
		\ [ 'L',        "organ#eagle#oper('demote_subtree')"        ] ,
		\ [ 'U',        "organ#eagle#oper('move_subtree_backward')" ] ,
		\ [ 'D',        "organ#eagle#oper('move_subtree_forward')"  ] ,
...
if ! exists('s:plugs_normal')
	let s:plugs_normal = [
		...
		\ [ 'organ-new'                , "organ#eagle#oper('new')"                   ] ,
		\ [ 'organ-promote'            , "organ#eagle#oper('promote')"               ] ,
		\ [ 'organ-demote'             , "organ#eagle#oper('demote')"                ] ,
		\ [ 'organ-promote-subtree'    , "organ#eagle#oper('promote_subtree')"       ] ,
		\ [ 'organ-demote-subtree'     , "organ#eagle#oper('demote_subtree')"        ] ,
		\ [ 'organ-move-subtree-up'    , "organ#eagle#oper('move_subtree_backward')" ] ,
		\ [ 'organ-move-subtree-down'  , "organ#eagle#oper('move_subtree_forward')"  ] ,
