...
if ! exists('s:command_meta_actions')
	let s:command_meta_actions = [
				...
				\ [ 'new'                , "organ#eagle#oper('new')"                   ] ,
				\ [ 'promote'            , "organ#eagle#oper('promote')"               ] ,
				\ [ 'demote'             , "organ#eagle#oper('demote')"                ] ,
				\ [ 'promote-subtree'    , "organ#eagle#oper('promote_subtree')"       ] ,
				\ [ 'demote-subtree'     , "organ#eagle#oper('demote_subtree')"        ] ,
				\ [ 'move-subtree-up'    , "organ#eagle#oper('move_subtree_backward')" ] ,
				\ [ 'move-subtree-down'  , "organ#eagle#oper('move_subtree_forward')"  ] ,
